...
import com.alexcupsa.wifithermal.attack.AttackVectorScreen
import com.alexcupsa.wifithermal.attack.WpsAttackScreen
            ...
            NavHost(navController = navController, startDestination = "dashboard") {
                composable("dashboard") {
                    AuditDashboardScreen(
                        ...
                        onNavigateToAttack = { navController.navigate("attack") },
                    )
                }
                composable("alerts") {
                    AlertsScreen(
                ...
                composable("attack") {
                    AttackVectorScreen(
                        onBack = { navController.popBackStack() },
                        onNavigateToWps = { navController.navigate("wps") },
                    )
                }
                composable("wps") {
                    WpsAttackScreen(onBack = { navController.popBackStack() })
                }
                composable("scan") {
                    ScanScreen(
                        onApClick = { bssid ->
